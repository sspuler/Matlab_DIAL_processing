...
filename = '/net/ftp/pub/temp/users/mhayman/DIAL-LAFE/wv_dial.170816.Python.nc';
n = datenum('2017-08-16 00:00:00', 'yyyy-mm-dd HH:MM:SS');
sub_grid = 0;
...
% plot the absoulte humdity
  ...
  set(h, 'EdgeColor', 'none'); 
  axis xy; colorbar('EastOutside'); caxis([0 20]);
